    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="flex-1 px-4 py-6 overflow-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Phone */}
          <div className="space-y-1">
            <label className="text-sm text-gray-300">휴대폰</label>
            <div className="flex gap-2">
              <Input
                type="tel"
                placeholder="자동 번호 입력"
          ...
          {isCodeSent && (
            <div className="space-y-1">
              <label className="text-sm text-gray-300">인증번호</label>
              <div className="flex gap-2">
                <Input
                  type="text"
                  placeholder="번호 입력"
                ...
                <Button
                  ...
                  disabled={!formData.verificationCode || isPhoneVerified}
