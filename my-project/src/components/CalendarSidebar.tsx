...
export function CalendarSidebar({
  ...
  const handleCreateCalendar = () => {
    ...
    if (onCreateCalendar) {
      ...
      setInternalCalendars([...internalCalendars, newCalendar]);
    }
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          {calendars.length > 0 ? calendars.map((calendar) => (
            <Card key={calendar.id} className="p-3 transition-all bg-card/50 border border-border hover:bg-card/70 bg-[rgba(255,255,255,1)] rounded-[12px]">
              <div className="flex items-center justify-between">
                <div 
